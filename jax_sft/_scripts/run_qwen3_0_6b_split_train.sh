...
SYNTHETIC_GENERATION_TEMPERATURE="${SYNTHETIC_GENERATION_TEMPERATURE:-${SYNTHETIC_TEMPERATURE}}"
...
echo "SYNTH_GEN_TEMP: ${SYNTHETIC_GENERATION_TEMPERATURE}"
echo "====================================================="
...
if [[ "${BACKEND}" == "ptx" ]]; then
  ...
  PTX_FLAGS+=(
    ...
    --synthetic_generation_temperature "${SYNTHETIC_GENERATION_TEMPERATURE}"
